package com.bignerdranch.android.navigationcomponenttabs.screens.main
...
import com.bignerdranch.android.navigationcomponenttabs.databinding.ActivityMainBinding
import com.bignerdranch.android.navigationcomponenttabs.screens.main.tabs.TabsFragment
...
class MainActivity : AppCompatActivity() {
    ...
    private val fragmentListener = object : FragmentManager.FragmentLifecycleCallbacks() {
        override fun onFragmentViewCreated(fm: FragmentManager, f: Fragment, v: View, savedInstanceState: Bundle?) {
            ...
            // Если это не вспомогательные фрагменты,то обновляем нав контроллер
    ...
    private fun prepareRootNavController(isSignedIn: Boolean, navController: NavController) {
        ...
        // Определяем стартовый экран,если пользователь залогинился то подставляем одну ветку,а если нет то другую
    ...
    // Этот метод ищет лэйбл и подставляет в тайтл

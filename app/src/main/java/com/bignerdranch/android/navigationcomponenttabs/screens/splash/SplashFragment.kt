...
import com.bignerdranch.android.navigationcomponenttabs.databinding.FragmentSplashBinding
import com.bignerdranch.android.navigationcomponenttabs.screens.main.MainActivity
import com.bignerdranch.android.navigationcomponenttabs.screens.main.MainActivityArgs
...
class SplashFragment : Fragment(R.layout.fragment_splash) {
    ...
    private fun launchMainScreen(isSignedIn: Boolean) {
        ...
        // Добавляем флаг,что бы закрыть текущий фрагмент
